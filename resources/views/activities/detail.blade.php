                        ...
                        @auth()
                            @if(auth()->user()->isStaff())
                                <a href="{{ route('organize.create') }}"
                                   ...
                                   aria-current="page">ผ่าน</a>
                                <a href="{{ route('organize.create') }}"
                                   class="block py-2 pl-6 ml-5 pr-4 text-black hover:text-gray-600 rounded md:bg-transparent md:text-black md:p-0"
                                   aria-current="page">ไม่ผ่าน</a>
                            @endif
                        @endauth
