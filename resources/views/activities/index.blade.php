...
@section('content')
        <div class="flex flex-col items-center gap-5 p-8 max-w-4xl mx-auto bg-white h-full">
            ...
            <a href="#" class="flex flex-col items-center bg-white border border-gray-800 rounded-lg shadow md:flex-row md:max-w-3xl hover:bg-gray-100 h-full md:h-48 md:justify-around">
                <img class="object-cover w-full rounded-t-lg h-48 md:h-full md:w-2/3 md:rounded-none md:rounded-l-lg" src="https://images.unsplash.com/photo-1516483638261-f4dbaf036963?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=686&q=80" alt="">
                <div class="flex justify-around py-6 md:p-0">
            ...
            <a href="#" class="flex flex-col items-center bg-white border border-gray-800 rounded-lg shadow md:flex-row md:max-w-3xl hover:bg-gray-100 h-full md:h-48 md:justify-around">
                <img class="object-cover w-full rounded-t-lg h-48 md:h-full md:w-2/3 md:rounded-none md:rounded-l-lg" src="https://images.unsplash.com/photo-1604824338889-ce1c51f1af7f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" alt="">
                <div class="flex justify-around py-6 md:p-0">
