...
@section('content')
    <div class="flex pr-36">
        ...
        <div class="flex flex-col items-center gap-5 p-8 w-full ml-20 bg-white h-full">
            <!-- title -->
            ...
            <a href="{{ route('activities.showDetail') }}"
                class="flex items-center bg-white border border-gray-800 rounded-lg shadow md:max-w-3xl hover:bg-gray-100 h-full md:h-48 md:justify-around">
