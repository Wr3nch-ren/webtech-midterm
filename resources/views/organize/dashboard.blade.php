            ...
            @section('content')
                ...
                <div class="w-5/6 h-screen p-6 pl-12 bg-slate-100 overflow-scroll">
                    ...
                    <div class="pr-16">
                        ...
                        <div id="myTabContent">
                            <div class="hidden flex-col space-y-3" id="profile" role="tabpanel"
                                aria-labelledby="profile-tab">

                                {{-- <x-register-event-list :user=$user></x-register-event-list> --}}
                            </div>
                            <div class="hidden flex-col space-y-3" id="dashboard" role="tabpanel"
                                aria-labelledby="dashboard-tab">
                                {{-- <x-accept-decline-register-event :user=$user"></x-accept-decline-register-event> --}}
                            </div>
                            <div class="hidden flex-col space-y-3" id="settings" role="tabpanel"
